...
import com.sevenup.cpm.domain.Group;
import com.sevenup.cpm.repository.GroupRepository;
...
class GroupResourceIT {
    ...
    public static Group createEntity(EntityManager em) {
        Group group = new Group().departmentId(DEFAULT_DEPARTMENT_ID).name(DEFAULT_NAME);
        return group;
    }
    ...
    public static Group createUpdatedEntity(EntityManager em) {
        Group group = new Group().departmentId(UPDATED_DEPARTMENT_ID).name(UPDATED_NAME);
        return group;
    }
    ...
    void putExistingGroup() throws Exception {
        ...
        updatedGroup.departmentId(UPDATED_DEPARTMENT_ID).name(UPDATED_NAME);
    ...
    void fullUpdateGroupWithPatch() throws Exception {
        ...
        partialUpdatedGroup.departmentId(UPDATED_DEPARTMENT_ID).name(UPDATED_NAME);
