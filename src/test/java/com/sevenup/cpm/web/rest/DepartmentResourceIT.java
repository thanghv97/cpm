...
import com.sevenup.cpm.domain.Department;
import com.sevenup.cpm.repository.DepartmentRepository;
...
class DepartmentResourceIT {
    ...
    public static Department createEntity(EntityManager em) {
        Department department = new Department().name(DEFAULT_NAME).idParent(DEFAULT_ID_PARENT);
        return department;
    }
    ...
    public static Department createUpdatedEntity(EntityManager em) {
        Department department = new Department().name(UPDATED_NAME).idParent(UPDATED_ID_PARENT);
        return department;
    }
    ...
    void createDepartment() throws Exception {
        ...
        assertThat(testDepartment.getIdParent()).isEqualTo(DEFAULT_ID_PARENT);
    }
    ...
    void getAllDepartments() throws Exception {
        ...
        restDepartmentMockMvc
            ...
            .andExpect(jsonPath("$.[*].idParent").value(hasItem(DEFAULT_ID_PARENT.intValue())));
    }
    ...
    void getDepartment() throws Exception {
        ...
        restDepartmentMockMvc
            ...
            .andExpect(jsonPath("$.idParent").value(DEFAULT_ID_PARENT.intValue()));
    }
    ...
    void putExistingDepartment() throws Exception {
        ...
        updatedDepartment.name(UPDATED_NAME).idParent(UPDATED_ID_PARENT);
        ...
        assertThat(testDepartment.getIdParent()).isEqualTo(UPDATED_ID_PARENT);
    }
    ...
    void partialUpdateDepartmentWithPatch() throws Exception {
        ...
        partialUpdatedDepartment.idParent(UPDATED_ID_PARENT);
    ...
    void fullUpdateDepartmentWithPatch() throws Exception {
        ...
        partialUpdatedDepartment.name(UPDATED_NAME).idParent(UPDATED_ID_PARENT);
